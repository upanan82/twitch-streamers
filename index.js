...
function table() {
	arr.forEach(function(item) {
		$.getJSON("https://wind-bow.hyperdev.space/twitch-api/channels/" + item + "?callback=?", function(trs) {
			$.getJSON("https://wind-bow.hyperdev.space/twitch-api/streams/" + item + "?callback=?", function(json) {
				if(json.stream == null) 
